        ...
        if (c == '#') {
            ...
            if (strcmp(directive, "#include") == 0) {
                ...
                if (c == '<' || c == '"') {
                    ...
                    int j = 0;
                    buffer[j++] = c;
                    while ((c = fgetc(fp)) != EOF && c != endChar) {
...
int isMultiCharOperator(char c, char next, char *op) {
    if ((c == '=' && next == '=') || (c == '!' && next == '=') || (c == '<' && next == '=') || (c == '>' && next == '=') || (c == '&' && next == '&') || (c == '|' && next == '|') || (c == '+' && next == '+') || (c == '-' && next == '-') || (c == '<' && next == '<') || (c == '>' && next == '>') || (c == '/' && next == '=') || (c == '*' && next == '=') || (c == '+' && next == '=') || (c == '-' && next == '=')) {
        op[0] = c;
        op[1] = next;
        op[2] = '\0';
        return 1;
